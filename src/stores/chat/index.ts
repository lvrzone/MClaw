...
export const useChatStore = create<ChatState>((set, get) => ({
  ...
  loadSessions: async () => {
    ...
    loadSessionsInFlight = (async () => {
      try {
        ...
        const result = await gateway.client.request('chat.sessions', {});
  ...
  deleteSession: async (key: string) => {
    ...
    await gateway.client.request('chat.deleteSession', { sessionKey: key });
  ...
  loadHistory: async (quiet = false) => {
    ...
    const loadPromise = (async () => {
      try {
        const result = await gateway.client!.request('chat.history', {
          sessionKey,
