...
import { CarouselProvider } from './components/ImageCarousel';
...
import { VSCodeChatPage } from './pages/VSCodeChat';
      ...
      <CarouselProvider>
        <TooltipProvider delayDuration={300}>
          ...
          <Route element={<MainLayout />}>
            ...
            <Route path="/vscode-chat" element={<VSCodeChatPage />} />
            <Route path="/models" element={<Models />} />
            <Route path="/studio" element={<Studio />} />
            <Route path="/autodev" element={<AutoDev />} />
