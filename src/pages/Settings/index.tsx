          ...
          {devModeUnlocked && (
            <>
              ...
              <div data-testid="settings-developer-section">
                <h2 data-testid="settings-developer-title" className="text-base font-semibold text-foreground mb-4">
                  {t('developer.title')}
                </h2>
            ...
            <div className="space-y-3 text-[14px] text-muted-foreground">
              ...
              <div className="flex gap-4 pt-3">
                <Button
                  ...
                  onClick={() => window.electron.openExternal('https://github.com/lvrzone')}
                >
                  {t('about.docs')}
                </Button>
                <Button
