...
export const ExecutionGraphCard = memo(function ExecutionGraphCard({
  ...
  return (
    <div
      ...
      className={cn(
        "relative w-full rounded-xl border p-3 will-change-transform overflow-hidden",
        // 基础样式
        active 
        ...
        // 动态背景 - 执行中时有蓝色扫光
        active && [
          "bg-gradient-to-br from-blue-50/60 via-indigo-50/30 to-blue-50/60",
          "dark:from-blue-900/40 dark:via-indigo-900/20 dark:to-blue-900/40",
          // 蓝色扫光效果
          "before:absolute before:inset-0 before:rounded-xl before:p-[1px]",
          "before:bg-gradient-to-r before:from-blue-500/40 before:via-indigo-500/60 before:to-blue-500/40",
          "before:-z-10",
          "after:absolute after:inset-0 after:rounded-xl after:overflow-hidden",
          "after:bg-gradient-to-r after:from-transparent after:via-white/20 after:to-transparent",
          "after:-translate-x-full after:animate-[shimmer_2s_ease-in-out_infinite]",
        ],
        !active && "bg-white/60 dark:bg-white/[0.03]"
      )}
    >
      {/* 头部 */}
