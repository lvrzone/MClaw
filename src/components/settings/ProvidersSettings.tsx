  ...
  return (
    <div data-testid="providers-settings" className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 data-testid="providers-settings-title" className="text-base font-semibold text-foreground tracking-tight" style={{ fontFamily: "'PingFang SC', 'Source Han Sans CN', -apple-system, sans-serif" }}>
          {t('aiProviders.title', 'AI 模型服务商')}
        </h2>
