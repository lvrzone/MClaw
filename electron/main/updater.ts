 ...
 * When you publish a new release on GitHub with a proper version tag,
 * the app will automatically detect and offer the update.
 */
...
export class AppUpdater extends EventEmitter {
  ...
  constructor() {
    ...
    // electron-updater will automatically check GitHub for new releases
    logger.info(`[Updater] Using GitHub Releases: ${GITHUB_OWNER}/${GITHUB_REPO}`);
    logger.info(`[Updater] Current version: ${app.getVersion()}`);
