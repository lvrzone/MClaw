...
if /i "%1"=="update" (
    echo openclaw is managed by MClaw ^(bundled version^).
    echo.
    echo To update openclaw, update MClaw:
    echo   Open MClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=MClaw
